...
var seedBookTypes = function () {
    ...
    var bookTypes = [
        { "type": "hardcover", "price": 7, "quantity": 14, "num_pages": 246 },
        { "type": "hardcover", "price": 31, "quantity": 16, "num_pages": 407},
        { "type": "paperback", "price": 22, "quantity": 3, "num_pages": 224},
        { "type": "leatherbound", "price": 38, "quantity": 15, "num_pages": 364},
        { "type": "hardcover", "price": 42, "quantity": 4, "num_pages": 380},
        { "type": "paperback", "price": 8, "quantity": 18, "num_pages": 265},
        { "type": "leatherbound", "price": 44, "quantity": 14, "num_pages": 424},
        { "type": "paperback", "price": 38, "quantity": 20, "num_pages": 278},
        { "type": "leatherbound", "price": 24, "quantity": 16, "num_pages": 132},
        { "type": "paperback", "price": 21, "quantity": 8, "num_pages": 404},
        { "type": "paperback", "price": 30, "quantity": 8, "num_pages": 101},
        { "type": "leatherbound", "price": 20, "quantity": 3, "num_pages": 167},
        { "type": "hardcover", "price": 12, "quantity": 13, "num_pages": 222},
        { "type": "paperback", "price": 27, "quantity": 25, "num_pages": 193},
        { "type": "ebook", "price": 27, "quantity": null, "num_pages": 193},
        { "type": "ebook", "price": 15, "quantity": null, "num_pages": 200},
        { "type": "ebook", "price": 12, "quantity": null, "num_pages": 206},
        { "type": "ebook", "price": 13, "quantity": null, "num_pages": 201},
        { "type": "ebook", "price": 15, "quantity": null, "num_pages": 210},
        { "type": "ebook", "price": 16, "quantity": null, "num_pages": 250},
        { "type": "ebook", "price": 16, "quantity": null, "num_pages": 245},
        { "type": "ebook", "price": 12, "quantity": null, "num_pages": 235}
...
db.sync({ force: true })
    ...
    .then(function(){
        ...
        // does not restrict books having repeat book_types
        let bookToSet, bookToSetIdx = 0;
        return Promise.all(bookTypes.map( book_type => {
            function getBookToSet(){
                return books[Math.floor(Math.random() * books.length)]
            }

            return book_type.setBook(getBookToSet())
        }))
    })
    .then(function(){
        var line_items
